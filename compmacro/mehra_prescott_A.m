...
gama=17.2999;			% Risk aversion parameter
beta=0.99;			% Discount factor

mu = 0.018;
delta  = fsolve(@(x) (1+0.018+x)^2*0.5+(1+0.018-x)^2*0.5-(1+0.018)^2-0.036^2,0.5,optimset('Display','off'));

l(1,1)=1+mu+delta;			% State space
l(2,1)=1+mu-delta;

pi=[0.43 0.57;0.57 0.43];	% Transition matrix
